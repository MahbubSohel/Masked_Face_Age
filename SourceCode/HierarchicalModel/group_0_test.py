...
def main():
    ...
    model.load_state_dict(torch.load('/home/cviplab/MaskAge/SourceCode/groupage/Hierarchy/3G_v2/3Gv2_0_RN_LW.pth.tar'))
    model.cuda()
    
    model = models.wide_resnet50_2(pretrained=True)
    num_ftrs = model.fc.in_features
    model.fc = nn.Linear(num_ftrs,16)
    model.load_state_dict(torch.load('/home/cviplab/MaskAge/SourceCode/groupage/Hierarchy/3G_v2/3Gv2_0_WRN_LW.pth.tar'))
    model.cuda()
    
    model = models.densenet121(pretrained=True)
    num_ftrs = model.classifier.in_features
    model.classifier = nn.Linear(num_ftrs, 16)
    model.load_state_dict(torch.load('/home/cviplab/MaskAge/SourceCode/groupage/Hierarchy/3G_v2/3Gv2_0_DN_LW.pth.tar'))
    model.cuda()
    
    model = models.mobilenet_v2(pretrained=True)
    model.classifier[1] = nn.Linear(1280, 16)
    model.load_state_dict(torch.load('/home/cviplab/MaskAge/SourceCode/groupage/Hierarchy/3G_v2/3Gv2_0_MN_LW.pth.tar'))
    model.cuda()
    '''
    model = models.squeezenet1_1(pretrained=True)
    model.classifier[1] = nn.Conv2d(512, 16, kernel_size=(1,1), stride=(1,1)) 
    model.load_state_dict(torch.load('/home/cviplab/MaskAge/SourceCode/groupage/Hierarchy/3G_v2/3Gv2_0_sqNet_LW.pth.tar'))
    model.cuda()
    '''
    model = models.shufflenet_v2_x1_0(pretrained=True)
    model.fc = nn.Linear(1024, 16)
    model.load_state_dict(torch.load('/home/cviplab/MaskAge/SourceCode/groupage/Hierarchy/3G_v2/3Gv2_0_shflNet_LW.pth.tar'))
    model.cuda()
    '''
    ...
    transformed_test_dataset = AgeEstimationDataset(csv_file='/home/cviplab/MaskAge/file_paths/3G_v2/group_0_test.csv',
...
def accuracy(output, target, topk=(1,)):
    ...
    prob,label= torch.topk(softprob, 16)
    # print(label)
    ...
    f = open('Err_3Gv2_0_sqNet_LW.txt', 'a')
